...
export const services: Service[] = [
  {
    ...
    longDescription: 'รับสร้างบ้านน็อคดาวน์ในนครสวรรค์ พื้นที่ใกล้เคียงและทั่วประเทศ ตั้งแต่การออกแบบ ผลิตโครงสร้างเหล็กกันสนิม จนถึงการติดตั้งหน้างาน เน้นคุณภาพและความตรงต่อเวลา',
