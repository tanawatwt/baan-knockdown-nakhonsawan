export const site = {
  ...
  url: 'https://banbanknockdown.com',
  description:
    'รับสร้างบ้านน็อคดาวน์ครบวงจร ออกแบบ ผลิต ติดตั้งหน้างาน โครงสร้างเหล็กกันสนิม สร้างเสร็จไว 15–45 วัน ราคาเริ่มต้น 39,000 บาท ให้บริการนครสวรรค์ กำแพงเพชร ชัยนาท พิษณุโลก อุทัยธานี พื้นที่ใกล้เคียงและทั่วประเทศ',
